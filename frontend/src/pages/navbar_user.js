    ...
    <div className="container flex flex-wrap items-center justify-between mx-auto">
      ...
      <div className="hidden w-full md:block md:w-auto" id="navbar-default">
        <ul className="items-center flex flex-col p-4 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:text-sm md:font-medium md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
          <li>
            <NavLink to="../homeUser" className={({ isActive }) => isActive ? "block py-2 pl-3 pr-4 text-blue-700 rounded md:bg-transparent md:p-0 dark:text-blue-500" : "block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"}>Home</NavLink>
          </li>
          <li>
            <NavLink to="../inputUser" className={({ isActive }) => isActive ? "block py-2 pl-3 pr-4 text-blue-700 rounded md:bg-transparent md:p-0 dark:text-blue-500" : "block py-2 pl-3 pr-4 text-gray-700 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-blue-700 md:p-0 dark:text-gray-400 md:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent"}>input baru</NavLink>
          </li>
          <li>
            <button id="dropdownDividerButton" data-dropdown-toggle="dropdownDivider"
              ...
              <div id="dropdownDivider" className="hidden z-10 w-32 bg-white rounded divide-y divide-gray-100 shadow">
                <ul className="py-1" aria-labelledby="dropdownDividerButton">
                  <li>
                    <NavLink to="../profileUser" className={({ isActive }) => isActive ? "text-left block py-2 px-4 text-sm text-blue-700 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white" : "text-left block py-2 px-4 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-700 dark:hover:text-white"}>Profile</NavLink>
                  </li>
                  <li>
